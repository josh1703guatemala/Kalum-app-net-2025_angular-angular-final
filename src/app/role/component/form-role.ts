...
export class FormRole implements OnInit {
  ...
  constructor(private dialogRoleFormRef: MatDialogRef<FormRole>, private formBuilder: FormBuilder, private roleService: RoleService, private router : Router, @Inject(MAT_DIALOG_DATA) public data: any) {
  ...
  save() {
    console.log('Lo que llega en save es:' + this.formRoleGroup.get('roleName')?.value);
