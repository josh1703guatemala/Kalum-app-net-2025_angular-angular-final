...
@Component({
  ...
  imports: [CommonModule, ReactiveFormsModule, MatCardModule, MatFormFieldModule, MatInputModule, MatButtonModule, RouterModule, MatTableModule, MatIconModule, MatPaginatorModule, MatDialogModule],
...
export class RoleComponent implements OnInit{
  ...
  constructor(private roleService: RoleService, private dialogForm: MatDialog, private formGroup : FormBuilder){
